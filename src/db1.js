...
// var sql = "INSERT INTO Product (Pid, Pname,Firstimg,Secondimg,Thirdimg,price) VALUES ?";
// var values = [
//     [1242, 'SD4231','/images/25.png','/images/26.png','/images/27.png',100],
//     [1243, 'DA4432','/images/28.png','/images/29.png','/images/30.png',200],
//     [1244, 'FH4643','/images/31.png','/images/32.png','/images/33.png',110],
//     [1245, 'GN4254','/images/34.png','/images/35.png','/images/36.png',120],
//     [1246, 'FC4965','/images/37.png','/images/38.png','/images/39.png',540],
//     [1247, 'DS4676','/images/40.png','/images/41.png','/images/42.png',330],
//     [1248, 'WA4187','/images/43.png','/images/44.png','/images/45.png',210],
//     [1249, 'SF4298','/images/46.png','/images/47.png','/images/48.png',250]
//   ];
//   connection.query(sql, [values], function (err, result) {
//     if (err) throw err;
//     console.log("Number of records inserted: " + result.affectedRows);
...
// var sql = "INSERT INTO Product (Pid, Pname,Firstimg,Secondimg,Thirdimg,price) VALUES ?";
// var values = [
//     [1250, 'WE4231','/images/49.png','/images/50.png','/images/51.png',100],
//     [1251, 'DF4432','/images/52.png','/images/53.png','/images/54.png',200],
//     [1252, 'FS4643','/images/55.png','/images/56.png','/images/57.png',110],
//     [1253, 'HZ4254','/images/58.png','/images/59.png','/images/60.png',120],
//     [1254, 'AC4965','/images/61.png','/images/62.png','/images/63.png',540],
//     [1255, 'FS4676','/images/64.png','/images/65.png','/images/66.png',330],
//     [1256, 'HA4187','/images/67.png','/images/68.png','/images/69.png',210],
//     [1257, 'SF4298','/images/70.png','/images/71.png','/images/72.png',250]
//   ];
//   connection.query(sql, [values], function (err, result) {
//     if (err) throw err;
//     console.log("Number of records inserted: " + result.affectedRows);
...
// var sql = "INSERT INTO Product (Pid, Pname,Firstimg,Secondimg,Thirdimg,price) VALUES ?";
// var values = [
//     [1258, 'FS4231','/images/73.png','/images/74.png','/images/75.png',400],
//     [1259, 'DA4432','/images/76.png','/images/77.png','/images/78.png',230],
//     [1260, 'SS4643','/images/79.png','/images/80.png','/images/81.png',120],
//     [1261, 'DZ4254','/images/82.png','/images/83.png','/images/84.png',120],
//     [1262, 'GD4965','/images/85.png','/images/86.png','/images/87.png',560],
//     [1263, 'AS4676','/images/88.png','/images/89.png','/images/90.png',550],
//     [1264, 'AA4187','/images/91.png','/images/92.png','/images/93.png',280],
//     [1265, 'SC4298','/images/94.png','/images/95.png','/images/96.png',290]
//   ];
//   connection.query(sql, [values], function (err, result) {
//     if (err) throw err;
//     console.log("Number of records inserted: " + result.affectedRows);
...
// sql = "Alter table Payment modify column Dates VARCHAR(255)";
// connection.query(sql, function (err, result) {
//   if (err) throw err;
//   console.log(result);
// });
